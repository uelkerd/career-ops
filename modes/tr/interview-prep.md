...
- **Aktarım (Hand-off) disiplini**: Adaya görüşmeler arası bölümlerde neleri kelimesi kelimesine tekrarlamaması GEREKTİĞİNİ açıkça söyle (örn. ard arda iki defa aynı şekilde anlatılan bir kanıt noktası senaryolaştırılmış ezber yanıtlar sinyali verir; bakış açısını değiştir).
...
- **Eledikleri (screened for) kırmızı bayraklar**: vize sürprizleri, maaş uyumsuzluğu, "her yere başvuruyor" enerjisi.
